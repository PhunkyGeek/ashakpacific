...
export const metadata: Metadata = {
  title: "Blog Details Page | Ashak Pacific LLC",
  description: "This is the Blog Details Page",
  // other metadata
};
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h2 className="mb-8 text-3xl leading-tight font-bold text-black sm:text-4xl sm:leading-tight dark:text-white">
                  How AIoT is Transforming Smart Mobility Systems
                </h2>
                <div className="border-body-color/10 mb-10 flex flex-wrap items-center justify-between border-b pb-4 dark:border-white/10">
                  ...
                  <div className="mb-5">
                    <a
                      href="#0"
                      className="bg-primary inline-flex items-center justify-center rounded-full px-4 py-2 text-sm font-semibold text-black"
                    >
                      Mobility AIoT
                    </a>
                  </div>
                ...
                <div>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg">
                    AIoT is revolutionizing mobility by merging artificial intelligence with real-time sensor data to optimize routes, improve safety, and reduce delays in transportation systems.
                  </p>
                  ...
                  <ul className="text-body-color mb-10 list-inside list-disc">
                    <li>Predictive route optimization using real-time data</li>
                    <li>Smart fleet tracking and diagnostics</li>
                    <li>Seamless integration with urban infrastructure</li>
                    <li>Lower carbon emissions via intelligent resource use</li>
                  </ul>
                  ...
                  <div className="bg-primary/10 relative z-10 mb-10 overflow-hidden rounded-md p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-body-color text-center text-base font-medium italic">
                      “AIoT is the invisible engine powering the future of transport, enabling systems that think, respond, and adapt in real-time.”
                    </p>
                  ...
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      ...
                      <div className="flex items-center">
                        <TagButton text="Mobility" />
                        <TagButton text="AIoT" />
                        <TagButton text="Logistics" />
                      </div>
                    </div>
                    <div className="mb-5">
