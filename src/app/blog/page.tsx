...
export const metadata: Metadata = {
  title: "Blog Page | Ashak Pacific LLC",
...
const Blog = () => {
  return (
    <>
      <Breadcrumb
        pageName="Blog Grid"
        description="Explore insights, innovations, and breakthroughs driving the future of AIoT, from smarter mobility and farming to intelligent homes, businesses, and education systems."
      />
