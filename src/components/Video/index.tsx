    ...
    <>
      <section className="relative z-10 py-16 md:py-20 lg:py-28">
        <div className="container">
          <SectionTitle
            title="A Future with AIoT"
            paragraph="At Ashak Pacific, we engineer intelligence into everyday life, creating smart solutions for transport, homes, farms, businesses, and classrooms. See how innovation drives real impact."
            center
            mb="80px"
          />
        </div>
