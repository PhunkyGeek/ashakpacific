          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                ...
                <Link
                  href="/contact"
                  className="ease-in-up shadow-btn hover:shadow-btn-hover bg-primary hover:bg-primary/90 hidden rounded-xs px-8 py-3 text-base font-medium text-black transition duration-300 md:block md:px-9 lg:px-6 xl:px-9"
                >
                  Join the Early Bird
                </Link>
                <div>
